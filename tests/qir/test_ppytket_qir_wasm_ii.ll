...
entry:
  ...
  %5 = call i32 @set_creg_to_int(i32 %3, i32 %4)
  %6 = call i32 @add_one(i32 %5)
  %7 = call i32 @set_creg_to_int(i32 %5, i32 %6)
  call void @no_return(i32 %7)
  call void @init()
  %8 = call i32 @no_parameters()
  %9 = call i32 @set_creg_to_int(i32 %7, i32 %8)
  ...
  call void @__quantum__rt__int_record_output(i32 %9, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @3, i32 0, i32 0))
...
declare i32 @set_creg_to_int(i32, i32)
...
declare i32 @pget_int_from_creg(i1*)

declare void @mz_to_int(%Qubit*, i32, i32)
