...
entry:
  ...
  call void @set_creg_bit(i1* %0, i32 1, i1 false)
  ...
  call void @set_creg_bit(i1* %0, i32 5, i1 true)
  ...
  call void @__quantum__rt__int_record_output(i32 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
