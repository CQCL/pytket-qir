...
define void @main() #0 {
entry:
  %0 = call i64 @init_reg(i64 15)
  %1 = call i64 @init_reg(i64 15)
  %2 = call i64 @init_reg(i64 15)
  %3 = call i64 @init_reg(i64 15)
  %4 = call i64 @init_reg(i64 15)
  %5 = call i64 @init_reg(i64 1)
