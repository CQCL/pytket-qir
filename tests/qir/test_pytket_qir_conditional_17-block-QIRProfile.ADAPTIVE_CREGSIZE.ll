...
condb32:                                          ; preds = %contb31
  %386 = add i64 %7, %174
  %387 = trunc i64 %386 to i20
  %388 = zext i20 %387 to i64
  br label %contb32

contb32:                                          ; preds = %condb32, %contb31
  %389 = phi i64 [ %388, %condb32 ], [ %383, %contb31 ]
  ...
  call void @__quantum__rt__int_record_output(i64 %389, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
  ret void
}
