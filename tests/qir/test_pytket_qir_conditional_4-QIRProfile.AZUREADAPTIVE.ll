; ModuleID = 'test_pytket_qir_conditional_4'
source_filename = "test_pytket_qir_conditional_4"
...
entry:
  ...
  %15 = and i64 %14, %11
  %16 = icmp eq i64 3, %15
  br i1 %16, label %condb0, label %contb0
...
contb0:                                           ; preds = %condb0, %entry
  ...
  call void @__quantum__rt__int_record_output(i64 %15, i8* null)
  ret void
}
