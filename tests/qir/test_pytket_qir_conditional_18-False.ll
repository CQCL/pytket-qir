; ModuleID = 'test_pytket_qir_conditional_18'
source_filename = "test_pytket_qir_conditional_18"
...
entry:
  ...
  %4 = call i1 @get_creg_bit(i1* %1, i64 0)
  br i1 %4, label %condb0, label %contb0
...
contb0:                                           ; preds = %condb0, %entry
  ...
  call void @__quantum__rt__int_record_output(i64 %6, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @1, i32 0, i32 0))
