...
entry:
  ...
  %2 = call i32 @get_int_from_creg(i1* %1)
  %3 = icmp eq i32 2, %2
  br i1 %3, label %then, label %else

then:                                             ; preds = %entry
  %4 = call i1 @get_creg_bit(i1* %0, i32 0)
  %5 = xor i1 %4, true
  call void @set_creg_bit(i1* %0, i32 0, i1 %5)
  br label %continue
...
continue:                                         ; preds = %else, %then
  ...
  call void @__quantum__rt__int_record_output(i32 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0))
  %7 = call i32 @get_int_from_creg(i1* %1)
  call void @__quantum__rt__int_record_output(i32 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
