; ModuleID = 'test_pytket_qir_4'
source_filename = "test_pytket_qir_4"
...
entry:
  ...
  %3 = call i32 @get_int_from_creg(i1* %0)
  %4 = call i32 @get_int_from_creg(i1* %1)
  %5 = or i32 %3, %4
  call void @set_creg_to_int(i1* %2, i32 %5)
  call void @__quantum__qis__h__body(%Qubit* null)
  %6 = call i1 @get_creg_bit(i1* %1, i32 4)
...
continue:                                         ; preds = %else, %then
  ...
  call void @__quantum__rt__int_record_output(i32 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0))
  %8 = call i32 @get_int_from_creg(i1* %1)
  call void @__quantum__rt__int_record_output(i32 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
  %9 = call i32 @get_int_from_creg(i1* %2)
  call void @__quantum__rt__int_record_output(i32 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
