...
entry:
  ...
  call void @set_one_bit_in_reg(i64 %2, i64 0, i1 true)
  call void @set_one_bit_in_reg(i64 %2, i64 1, i1 false)
  call void @set_one_bit_in_reg(i64 %2, i64 2, i1 false)
  call void @set_one_bit_in_reg(i64 %2, i64 3, i1 true)
  call void @set_one_bit_in_reg(i64 %2, i64 4, i1 true)
  call void @set_one_bit_in_reg(i64 %2, i64 5, i1 true)
  call void @set_one_bit_in_reg(i64 %2, i64 6, i1 true)
  call void @__quantum__qis__h__body(%Qubit* null)
  call void @__quantum__qis__cnot__body(%Qubit* null, %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* null, %Result* null)
  %3 = call i1 @__quantum__qis__read_result__body(%Result* null)
  call void @set_one_bit_in_reg(i64 %0, i64 0, i1 %3)
  call void @__quantum__qis__mz__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Result* inttoptr (i64 1 to %Result*))
  %4 = call i1 @__quantum__qis__read_result__body(%Result* inttoptr (i64 1 to %Result*))
  call void @set_one_bit_in_reg(i64 %0, i64 1, i1 %4)
...
continue:                                         ; preds = %else, %then
  %7 = call i1 @read_bit_from_reg(i64 %0, i64 1)
  br i1 %7, label %then1, label %else2

then1:                                            ; preds = %continue
  %8 = sub i64 %2, %0
  call void @set_all_bits_in_reg(i64 %1, i64 %8)
  br label %continue3
...
continue3:                                        ; preds = %else2, %then1
  %9 = sub i64 %2, %1
  call void @set_all_bits_in_reg(i64 %0, i64 %9)
