...
entry:
  ...
  call void @__quantum__qis__h__body(%Qubit* null)
  %14 = call i1 @get_creg_bit(i1* %0, i64 4)
...
then:                                             ; preds = %entry
  ...
  %17 = call i64 @get_int_from_creg(i1* %2)
  %18 = call i64 @get_int_from_creg(i1* %1)
  %19 = or i64 %17, %18
  call void @set_creg_to_int(i1* %3, i64 %19)
  br label %continue

continue:                                         ; preds = %else, %then
  call void @mz_to_reg(%Qubit* inttoptr (i64 2 to %Qubit*), i1* %3, i64 2)
  call void @mz_to_reg(%Qubit* inttoptr (i64 1 to %Qubit*), i1* %3, i64 3)
  call void @mz_to_reg(%Qubit* null, i1* %3, i64 4)
