...
continue:                                         ; preds = %else, %then
  %24 = call i1 @get_creg_bit(i1* %1, i32 1)
...
continue3:                                        ; preds = %else2, %then1
  %25 = call i1 @get_creg_bit(i1* %1, i32 2)
...
continue6:                                        ; preds = %else5, %then4
  %26 = call i1 @get_creg_bit(i1* %1, i32 3)
...
continue9:                                        ; preds = %else8, %then7
  %27 = call i1 @get_creg_bit(i1* %1, i32 4)
...
continue12:                                       ; preds = %else11, %then10
  %28 = call i1 @get_creg_bit(i1* %1, i32 5)
...
continue15:                                       ; preds = %else14, %then13
  ...
  %29 = call i32 @get_int_from_creg(i1* %0)
  call void @__quantum__rt__int_record_output(i32 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0))
  %30 = call i32 @get_int_from_creg(i1* %1)
  call void @__quantum__rt__int_record_output(i32 %30, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @1, i32 0, i32 0))
