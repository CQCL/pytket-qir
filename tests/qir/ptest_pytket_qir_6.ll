; ModuleID = 'ptest_pytket_qir_6'
source_filename = "ptest_pytket_qir_6"
...
entry:
  ...
  %5 = call i64 @mz_to_int(%Qubit* null, i64 %4, i64 4)
  %6 = call i1 @get_bit_from_int(i64 %5, i64 4)
...
contb0:                                           ; preds = %condb0, %entry
  ...
  call void @__quantum__rt__int_record_output(i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
