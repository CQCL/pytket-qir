; ModuleID = 'test_bitreg_as_bit_3'
source_filename = "test_bitreg_as_bit_3"
...
entry:
  ...
  %1 = call i1* @create_creg(i64 2)
  %2 = call i1 @get_creg_bit(i1* %0, i64 0)
  %3 = call i1 @get_creg_bit(i1* %1, i64 0)
  %4 = xor i1 %2, %3
  call void @set_creg_bit(i1* %0, i64 0, i1 %4)
  ...
  call void @__quantum__rt__int_record_output(i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
  ret void
}
