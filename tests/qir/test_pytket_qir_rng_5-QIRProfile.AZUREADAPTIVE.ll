...
define void @main() #0 {
entry:
  call void @___set_random_index(i64 2056)
  %0 = call i64 @___random_int()
  call void @__quantum__rt__array_record_output(i64 2, i8* null)
  call void @__quantum__rt__int_record_output(i64 %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @0, i32 0, i32 0))
  call void @__quantum__rt__int_record_output(i64 2056, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0))
  ret void
}
...
declare void @___set_random_index(i64)
