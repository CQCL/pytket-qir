...
entry:
  ...
  %9 = icmp eq i64 3, %8
  call void @set_one_bit_in_reg(i1* %1, i64 3, i1 %9)
  %10 = call i64 @read_all_bits_from_reg(i1* %0)
  %11 = icmp eq i64 4, %10
  call void @set_one_bit_in_reg(i1* %1, i64 4, i1 %11)
  %12 = call i64 @read_all_bits_from_reg(i1* %0)
  %13 = icmp eq i64 4, %12
  call void @set_one_bit_in_reg(i1* %1, i64 5, i1 %13)
  %14 = call i1 @read_bit_from_reg(i1* %1, i64 0)
...
continue:                                         ; preds = %else, %then
  %15 = call i1 @read_bit_from_reg(i1* %1, i64 1)
...
continue3:                                        ; preds = %else2, %then1
  %16 = call i1 @read_bit_from_reg(i1* %1, i64 2)
...
continue6:                                        ; preds = %else5, %then4
  %17 = call i1 @read_bit_from_reg(i1* %1, i64 3)
...
continue9:                                        ; preds = %else8, %then7
  %18 = call i1 @read_bit_from_reg(i1* %1, i64 4)
...
continue12:                                       ; preds = %else11, %then10
  %19 = call i1 @read_bit_from_reg(i1* %1, i64 5)
...
continue15:                                       ; preds = %else14, %then13
  ...
  %21 = call i64 @read_all_bits_from_reg(i1* %1)
