...
entry:
  ...
  %3 = call i1 @read_bit_from_reg(i64 %0, i64 0)
...
continue:                                         ; preds = %else, %then
  %4 = call i1 @read_bit_from_reg(i64 %0, i64 0)
...
continue6:                                        ; preds = %else5, %then4
  %6 = call i1 @read_bit_from_reg(i64 %0, i64 0)
...
continue12:                                       ; preds = %else11, %then10
  ...
  br i1 %8, label %then13, label %else14
...
continue15:                                       ; preds = %else14, %then13
  %9 = call i1 @read_bit_from_reg(i64 %0, i64 0)
  br i1 %9, label %then16, label %else17
...
continue18:                                       ; preds = %else17, %then16
  %10 = call i1 @read_bit_from_reg(i64 %0, i64 0)
  br i1 %10, label %then19, label %else20
