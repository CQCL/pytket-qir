...
def test_pytket_qir() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_2() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_2", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_3() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_3", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_4() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_4", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_5() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_5", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_6() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_6", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_7() -> None:
    ...
    result = pytket_to_qir(circ, name="ptest_pytket_qir_7", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_8() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_8", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_9() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_9", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_10() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_10", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_11() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_11", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_12() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_12", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_13() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_13", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_14() -> None:
    ...
    result = pytket_to_qir(
        c, name="ptest_pytket_qir_14", int_type=64, qir_format=QIRFormat.STRING, profile=True
    )
...
def test_pytket_qir_14_b() -> None:
    ...
    result = pytket_to_qir(
        c, name="ptest_pytket_qir_14_b", int_type=64, qir_format=QIRFormat.STRING, profile=True
    )
...
def test_pytket_qir_15() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_15", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_16() -> None:
    ...
    with pytest.raises(ValueError):
        pytket_to_qir(c, name="ptest_pytket_qir_16", qir_format=QIRFormat.STRING, profile=True)
...
def test_pytket_qir_17() -> None:
    ...
    result = pytket_to_qir(c, name="ptest_pytket_qir_17", qir_format=QIRFormat.STRING, profile=True)
