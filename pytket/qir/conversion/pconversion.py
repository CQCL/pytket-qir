...
class PQirGenerator:
    ...
    def get_ssa_vars(self, reg_name: str) -> Value:
        ...
        #if "c" in self.ssa_vars:
        #    return self.ssa_vars["c"]
    ...
    def conv_conditional(self, command: Command, op: Conditional) -> None:
        ...
        if op.op.type == OpType.CircBox:
            ...
            # entry = self.module.entry_block
            
            condb = pyqir.BasicBlock(self.module.module.context, f"condb{self.block_count}", entry_point)
            continueb = pyqir.BasicBlock(self.module.module.context, f"continueb{self.block_count}", entry_point)
            ...
            if op.width == 1:  # only one conditional bit
                ...
                self.module.module.builder.condbr(ssabool, condb, continueb)
                ...
                self.module.module.builder.br(continueb)
                self.module.module.builder.insert_at_end(continueb)
